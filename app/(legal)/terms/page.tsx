...
export const metadata: Metadata = {
  title: 'Terms of Use',
  description: 'ItemssyCrafts terms of use for digital downloads and physical prints.',
};
...
export default function TermsPage() {
  return (
    <div style={{ maxWidth: 720, margin: '0 auto', padding: '64px clamp(20px, 4vw, 40px) 100px' }}>
      ...
      {[
        { title: 'Acceptance of terms', body: 'By using ItemssyCrafts and purchasing our products, you agree to these terms. If you do not agree, please do not use the site.' },
        ...
        { title: 'Physical prints', body: 'Physical print orders are fulfilled by our partner Printful. Production begins shortly after payment. Once in production, orders cannot be cancelled or modified. Damaged or incorrect items will be replaced at no cost.' },
        ...
        { title: 'Intellectual property', body: 'All designs, images, and content on ItemssyCrafts are the intellectual property of ItemssyCrafts. Unauthorized reproduction, distribution, or modification of any content is strictly prohibited.' },
        { title: 'Limitation of liability', body: 'ItemssyCrafts is not liable for any indirect, incidental, or consequential damages arising from the use of our products. Our maximum liability is limited to the amount paid for the relevant order.' },
        ...
        { title: 'Contact', body: 'For any questions about these terms, contact us at itemssycrafts@gmail.com.' },
      ].map(s => (
